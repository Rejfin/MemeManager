    ...
    en: {
      translation: {
        ...
        settings: {
          ...
          blurhash: 'Blurhash',
          blurhashDesc:
            'Blurhash is a string that represents an image in blurred form. It is used before downloading the file as a palceholder and it is generating when you send file to server (forcing enabled for now)',
          ...
          accountHasBeenCleared:
            'Your account has been cleared.\nRemoved Memes: {{memesCount}}\nRemoved Tags: {{tagsCount}}',
          accountFailedToDelete:
            'Failed to remove your account. Make sure the password you entered is correct and that you are still logged in',
          accountFailedToClean:
            'Failed to clean your account. Make sure the password you entered is correct and that you are still logged in',
        },
      },
    },
  },
